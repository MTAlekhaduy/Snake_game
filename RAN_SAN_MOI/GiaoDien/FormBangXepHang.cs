...
namespace RAN_SAN_MOI
{
    public partial class FormBangXepHang : Form
    {
        ...
        private void NapDuLieu()
        {
            ...
            List<ScoreRecord> top10 = ScoreManager.LayBangXepHang(); // ← đổi ở đây
            ...
            for (int i = 0; i < top10.Count; i++)
            {
                ...
                // ← đổi ở đây
                if (ScoreManager.NguoiChoiHienTai != null &&
                    r.TenNguoiChoi == ScoreManager.NguoiChoiHienTai.TenNguoiChoi)
        ...
        private void btnXoaTatCa_Click(object sender, EventArgs e)
        {
            ...
            ScoreManager.XoaTatCaDiem(); // ← đổi ở đây
            NapDuLieu();
        }
