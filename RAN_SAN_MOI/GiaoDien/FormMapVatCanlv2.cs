...
namespace RAN_SAN_MOI
{
    public partial class FormMapVatCanlv2 : Form
    {
        ...
        {
            InitializeComponent();
            this.FormClosing += FormMapVatCanlv2_FormClosing;
        ...
        private void FormMapVatCanlv2_Load(object sender, EventArgs e)
        {
            ...
            if (snapshot != null)
            {
                ...
                _quanLyVatCan.DanhSachVatCan = TrangThaiGameRecord.DeserializeVatCan(snapshot.DanhSachVatCan);
        ...
        private void FormMapVatCanlv2_FormClosing(object sender, FormClosingEventArgs e)
        {
